...
import com.example.confirmemail.email.EmailSender;
...
public class UserServiceImpl implements UserService {
    ...
    public String signUp(User user) {
        boolean userIsExit = userRepository
        ...
        confirmationToken.setExpectedAt(LocalDateTime.now().plusMinutes(15));
        confirmationTokenService.saveConfirmationToken(confirmationToken);
        String link = "http://localhost:8080/api/v1/confirm?token=" + token;
        try {
            emailSender.send("Confirm email",
